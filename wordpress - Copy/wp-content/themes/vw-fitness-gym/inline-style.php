<?php
	...
	if($vw_fitness_gym_first_color != false){
		$vw_fitness_gym_custom_css .='.wp-block-button .wp-block-button__link:hover{';
	...
	$vw_fitness_gym_products_border_radius = get_theme_mod('vw_fitness_gym_products_border_radius');
